...
*Process*:
1. Fork → make changes → validate locally → create merge request
...
* **Coverage**: Aim for ≥80% coverage (run `just coverage`)
...
6. **Celebration**: Your contribution is live! 🎉
...
**Thank you for contributing! Together we build systems that don't decay under pressure, communities that support experimentation without shame, and infrastructure that respects human autonomy.** 🎖️
